...
public class PolymerWildCucumberBlock extends WildCropBlock implements FactoryBlock, TransparentPlant {
    ...
    public PolymerWildCucumberBlock(Holder<MobEffect> suspiciousStewEffect, int effectDuration, Properties properties) {
    ...
    public static class Model extends BlockModel {
        ...
        static{
            MODELS.add(ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(CulturalDelights.MOD_ID, "block/wild_cucumbers")));
        }
